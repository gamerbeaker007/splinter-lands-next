...
interface Props {
  countAbilityBoosts: Partial<Record<Resource, number>>;
}

export default function AbilityBoost({ countAbilityBoosts }: Props) {
        ...
        orderedResources.map((resource) => (
          ...
          >
            ...
            <Typography
              ...
              sx={{ minHeight: 20 }}
            >
              {`Bountiful ${capitalize(resource.toLowerCase())}`}
            </Typography>
          </Paper>
        ))}
    </>
